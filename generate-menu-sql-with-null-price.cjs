// Generate SQL inserts for menu items with correct column names and NULL price
const fs = require('fs');
...
for (const item of menuData) {
  ...
  // Create an SQL INSERT statement with correct column names (snake_case) and NULL price
...
// Write SQL to a file
fs.writeFileSync('menu-items-insert-null-price.sql', allSql);
console.log('SQL insert statements generated in menu-items-insert-null-price.sql');
