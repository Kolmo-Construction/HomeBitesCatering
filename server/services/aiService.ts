...
Provide your output ONLY in the following JSON format. Fill fields with null if not found or not applicable.
{
  ...
  "aiCalendarConflictAssessment": "Brief assessment of any potential calendar conflicts (e.g., 'No conflict', 'Potential conflict: Wedding on same day', 'Date flexible, check availability')",
