...
async function runMigration() {
  ...
  try {
    ...
    console.log('Starting migration to flexible questionnaire architecture...');
    ...
    // Create condition type enum if it doesn't exist
    await client.query(`
      DO $$
      BEGIN
    ...
    // Create questionnaire definitions table
    await client.query(`
    ...
    // Create questionnaire sections table (reusable templates)
    await client.query(`
    ...
    // Create page-section relationship table
    await client.query(`
    ...
    // Create section-question relationship table
    await client.query(`
