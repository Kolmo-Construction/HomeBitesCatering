...
--
-- Name: questionnaire_component_types; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.questionnaire_component_types (
    id integer NOT NULL,
...
ALTER TABLE public.questionnaire_component_types OWNER TO neondb_owner;

--
-- Name: questionnaire_component_types_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.questionnaire_component_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.questionnaire_component_types_id_seq OWNER TO neondb_owner;

--
-- Name: questionnaire_component_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.questionnaire_component_types_id_seq OWNED BY public.questionnaire_component_types.id;
...
--
-- Name: questionnaire_page_sections; Type: TABLE; Schema: public; Owner: neondb_owner
--

CREATE TABLE public.questionnaire_page_sections (
    id integer NOT NULL,
...
ALTER TABLE public.questionnaire_page_sections OWNER TO neondb_owner;

--
-- Name: questionnaire_page_sections_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.questionnaire_page_sections_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.questionnaire_page_sections_id_seq OWNER TO neondb_owner;

--
-- Name: questionnaire_page_sections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.questionnaire_page_sections_id_seq OWNED BY public.questionnaire_page_sections.id;
...
--
-- Name: questionnaire_sections; Type: TABLE; Schema: public; Owner: neondb_owner
--
...
ALTER TABLE public.questionnaire_sections OWNER TO neondb_owner;

--
-- Name: questionnaire_sections_id_seq; Type: SEQUENCE; Schema: public; Owner: neondb_owner
--

CREATE SEQUENCE public.questionnaire_sections_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.questionnaire_sections_id_seq OWNER TO neondb_owner;

--
-- Name: questionnaire_sections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neondb_owner
--

ALTER SEQUENCE public.questionnaire_sections_id_seq OWNED BY public.questionnaire_sections.id;
...
--
-- Name: questionnaire_component_types id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_component_types ALTER COLUMN id SET DEFAULT nextval('public.questionnaire_component_types_id_seq'::regclass);
...
--
-- Name: questionnaire_page_sections id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_page_sections ALTER COLUMN id SET DEFAULT nextval('public.questionnaire_page_sections_id_seq'::regclass);
...
--
-- Name: questionnaire_sections id; Type: DEFAULT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_sections ALTER COLUMN id SET DEFAULT nextval('public.questionnaire_sections_id_seq'::regclass);
...
--
-- Data for Name: questionnaire_component_types; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.questionnaire_component_types (id, type_key, component_category, display_name, description, config_schema, is_active, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: questionnaire_page_sections; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.questionnaire_page_sections (id, page_id, section_id, section_order, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: questionnaire_sections; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--

COPY public.questionnaire_sections (id, title, description, template_key, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: questionnaire_component_types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.questionnaire_component_types_id_seq', 1, false);
...
--
-- Name: questionnaire_page_sections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.questionnaire_page_sections_id_seq', 1, false);
...
--
-- Name: questionnaire_sections_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.questionnaire_sections_id_seq', 1, false);
...
--
-- Name: questionnaire_component_types questionnaire_component_types_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_component_types
    ADD CONSTRAINT questionnaire_component_types_pkey PRIMARY KEY (id);


--
-- Name: questionnaire_component_types questionnaire_component_types_type_key_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_component_types
    ADD CONSTRAINT questionnaire_component_types_type_key_key UNIQUE (type_key);
...
--
-- Name: questionnaire_page_sections questionnaire_page_sections_page_id_section_id_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_page_sections
    ADD CONSTRAINT questionnaire_page_sections_page_id_section_id_key UNIQUE (page_id, section_id);


--
-- Name: questionnaire_page_sections questionnaire_page_sections_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_page_sections
    ADD CONSTRAINT questionnaire_page_sections_pkey PRIMARY KEY (id);
...
--
-- Name: questionnaire_sections questionnaire_sections_pkey; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--
...
--
-- Name: questionnaire_sections questionnaire_sections_template_key_key; Type: CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_sections
    ADD CONSTRAINT questionnaire_sections_template_key_key UNIQUE (template_key);
...
--
-- Name: questionnaire_page_sections questionnaire_page_sections_page_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_page_sections
    ADD CONSTRAINT questionnaire_page_sections_page_id_fkey FOREIGN KEY (page_id) REFERENCES public.questionnaire_pages(id) ON DELETE CASCADE;


--
-- Name: questionnaire_page_sections questionnaire_page_sections_section_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neondb_owner
--

ALTER TABLE ONLY public.questionnaire_page_sections
    ADD CONSTRAINT questionnaire_page_sections_section_id_fkey FOREIGN KEY (section_id) REFERENCES public.questionnaire_sections(id) ON DELETE CASCADE;
