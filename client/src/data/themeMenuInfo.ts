...
export const themeMenuData = {
  breakfast_brunch: {
    ...
    description: "You know there is nothing better than breakfast to get the new day off to a good start!",
    packages: [
      {
        id: "grab_and_go",
        name: "Grab and Go",
        price: 10.95,
        description: "Quick and easy morning meal with your choice of breakfast items. Package includes 1 item per person.",
        minGuestCount: 10
      },
      {
        id: "continental",
      ...
      },
      {
        ...
        name: "The Full Monty",
        price: 22.95,
        description: "A delicious assortment of anything you could imagine for a complete sit-down or buffet style service.",
        minGuestCount: 15
      }
    ],
    categories: {
      service_style: {
        ...
        items: [
          { id: "drop_off", name: "Drop off", upcharge: 0 },
          { id: "buffet_standard", name: "Buffet Standard", upcharge: 5 },
          { id: "buffet_unattended", name: "Buffet set up (unattended)", upcharge: 3 },
          { id: "buffet_full_service", name: "Buffet Full Service", upcharge: 8 },
          { id: "family_style", name: "Family Style Service", upcharge: 10 }
        ]
      },
      grab_and_go_bites: {
        title: "Grab and Go Bites",
        description: "Choose from our selection of breakfast bites (minimum purchase of 10 of any single item)",
        items: [
          { id: "breakfast_burrito_mexi", name: "Breakfast Burrito - The Mexi", upcharge: 0 },
          { id: "breakfast_burrito_carnivore", name: "Breakfast Burrito - The Carnivore", upcharge: 0 },
          { id: "breakfast_burrito_cali", name: "Breakfast Burrito - The Cali", upcharge: 0 },
          { id: "breakfast_burrito_green", name: "Breakfast Burrito - The Green (Vegetarian)", upcharge: 0 },
          { id: "croissandwich_egg_ham", name: "Croissandwich - Egg Ham", upcharge: 0 },
          { id: "croissandwich_turkey_club", name: "Croissandwich - Turkey Club", upcharge: 0 },
          { id: "croissandwich_brisket", name: "Croissandwich - Brisket (Carved Brisket)", upcharge: 2.00 },
          { id: "quiche_lorraine", name: "Quiche - Lorraine", upcharge: 0 },
          { id: "quiche_spinach", name: "Quiche - Spinach", upcharge: 0 },
          { id: "quiche_denver", name: "Quiche - Denver", upcharge: 0 }
        ]
      },
      grab_and_go_snacks: {
        ...
        items: [
          { id: "muffin_blueberry", name: "Muffin Blueberry", upcharge: 0 },
          { id: "muffin_chocolate", name: "Muffin Chocolate", upcharge: 0 },
          { id: "muffin_banana", name: "Muffin Banana", upcharge: 0 },
          { id: "croissandwich_caprese", name: "Croissandwich - Caprese (Vegetarian)", upcharge: 0 },
          { id: "granola_caramel_almond", name: "Granola Bar - KIND - Caramel Almond & Sea Salt", upcharge: 0 },
          { id: "granola_dark_chocolate", name: "Granola Bar - KIND - Dark Chocolate Almond & Sea Salt", upcharge: 0 },
          { id: "granola_peanut_butter", name: "Granola Bar - KIND - Peanut Butter Dark Chocolate", upcharge: 0 },
          { id: "granola_almond_coconut", name: "Granola Bar - KIND - Almond & Coconut Chewy Granola", upcharge: 0 },
          { id: "yogurt_vanilla", name: "Greek Yogurt - OUI Vanilla Yogurt plain", upcharge: 0 },
          { id: "yogurt_strawberry", name: "Greek Yogurt - OUI Strawberry Yogurt plain", upcharge: 0 },
          { id: "yogurt_mixed_berry", name: "Greek Yogurt - OUI Mixed Berry Yogurt plain", upcharge: 0 },
          { id: "fruit_cups", name: "Fruit - Assortment on cups", upcharge: 0 }
        ]
      },
      grab_and_go_beverages: {
        title: "Grab and Go Beverages",
        description: "Complete your breakfast with refreshing beverage options",
        items: [
          { id: "coffee_regular", name: "Home Bites 96 oz Box of Coffee - Regular", upcharge: 15 },
          { id: "coffee_decaf", name: "Home Bites 96 oz Box of Coffee - Decaf", upcharge: 15 },
          { id: "starbucks_regular", name: "Starbucks Coffee Traveler - Pike Regular", upcharge: 20 },
          { id: "starbucks_decaf", name: "Starbucks Coffee Traveler - Pike Decaf", upcharge: 20 },
          { id: "dunkin_regular", name: "Dunkin Box O' Joe - Regular", upcharge: 19 },
          { id: "dunkin_decaf", name: "Dunkin Box O' Joe - Decaf", upcharge: 19 },
          { id: "starbucks_canned", name: "Starbucks Ready to Drink Coffee, Espresso & Cream, 6.5oz Cans", upcharge: 0 },
          { id: "dunkin_hot_chocolate", name: "Dunkin Hot Chocolate - (Box O'Joe Hot)", upcharge: 19 },
          { id: "tea_assorted", name: "Home Bites 96 oz Box of Tea - Assorted Flavors", upcharge: 15 },
          { id: "cold_brew_vanilla", name: "Lucky Jack Cold Brew Coffee Vanilla - Draft Pour Nitro Latte w/Oat milk", upcharge: 1 },
          { id: "juice_orange", name: "Juice - Orange", upcharge: 0 },
          { id: "juice_apple", name: "Juice - Apple", upcharge: 0 },
          { id: "juice_grapefruit", name: "Juice - Grapefruit", upcharge: 0 },
          { id: "juice_cranberry", name: "Juice - Cranberry", upcharge: 0 },
          { id: "juice_tomato", name: "Juice - Tomato", upcharge: 0 },
          { id: "v8_classic", name: "Juice - V8 Classic", upcharge: 0 },
          { id: "v8_peach_mango", name: "V8 +ENERGY Peach Mango", upcharge: 1 },
          { id: "v8_black_cherry", name: "V8 +ENERGY Black Cherry", upcharge: 1 },
          { id: "v8_pomegranate", name: "V8 +ENERGY Pomegranate Blueberry", upcharge: 1 }
        ]
      },
      continental_staples: {
        title: "Continental Breakfast Staple Choices",
        description: "Pick 3 staple items",
        limits: {
          "continental": 3
        },
        items: [
          { id: "assorted_pastries", name: "Assorted Pastries - muffins, danish, whole grain bagels with butter and jam", upcharge: 0 },
          { id: "cereal_variety", name: "Cereal Variety - individual packs with 2% milk and almond milk (if requested)", upcharge: 0 },
          { id: "oatmeal", name: "Oatmeal - individual variety with cream (half/half), butter and jam", upcharge: 0 },
          { id: "quiche", name: "Quiche (3 fluffy eggs)", upcharge: 1 },
          { id: "seasonal_fruit", name: "Seasonal fruit such as apples, bananas, and oranges", upcharge: 0 },
          { id: "yogurt_parfait", name: "Yogurt Parfait with granola", upcharge: 0 }
        ]
      },
      continental_beverages: {
        title: "Continental Breakfast - Beverage choices",
      ...
      eggs: {
        title: "American Breakfast - Egg Choices",
        description: "Choose 1",
        limits: {
          "american": 1
        },
        items: [
          { id: "scrambled", name: "Scrambled", upcharge: 0 },
          { id: "fried", name: "Fried", upcharge: 0 },
          { id: "over_easy", name: "Over easy", upcharge: 0 },
          { id: "egg_whites", name: "Egg whites", upcharge: 1 },
          { id: "omelette", name: "Omelette", upcharge: 1 }
        ]
      },
      breakfast_meats: {
        title: "American Breakfast - Meats",
        description: "Choose 2",
        limits: {
          "american": 2
        },
        items: [
          { id: "bacon", name: "Bacon", upcharge: 0 },
          { id: "sausage_links", name: "Sausage links", upcharge: 0 },
          { id: "sausage_patties", name: "Sausage patties", upcharge: 0 },
          { id: "ham", name: "Ham", upcharge: 0 },
          { id: "turkey_bacon", name: "Turkey bacon", upcharge: 1 },
          { id: "corned_beef_hash", name: "Corned beef hash", upcharge: 2 },
          { id: "tofu", name: "Tofu", upcharge: 0 }
        ]
      },
      potatoes: {
        title: "American Breakfast - Potatoes",
        description: "Choose 1",
        limits: {
          "american": 1
        },
        items: [
          { id: "hash_browns", name: "Hash browns", upcharge: 0 },
          { id: "country_style", name: "Country style with onions", upcharge: 0 },
          { id: "obrien", name: "O'Brien", upcharge: 0 },
          { id: "red_bliss", name: "Red Bliss", upcharge: 0 }
        ]
      },
      breads: {
        title: "American/Full Monty Breakfast - Breads",
        description: "Choose your bread options",
        limits: {
          "american": 1,
          "full_monty": 3
        },
        items: [
          { id: "toast", name: "Toast with butter", upcharge: 0 },
          { id: "english_muffin", name: "English muffin with butter", upcharge: 0 },
          { id: "biscuits_gravy", name: "Biscuits with gravy", upcharge: 1 },
          { id: "pancakes", name: "Pancakes", upcharge: 1 },
          { id: "waffles", name: "Waffles", upcharge: 1 },
          { id: "french_toast", name: "French toast", upcharge: 1 },
          { id: "bagels_cream_cheese", name: "Bagels with cream cheese", upcharge: 0 },
          { id: "croissants", name: "Croissants", upcharge: 0 },
          { id: "whole_wheat", name: "Whole wheat", upcharge: 0 },
          { id: "sourdough", name: "Sourdough", upcharge: 0 },
          { id: "multigrain", name: "Multigrain", upcharge: 0 },
          { id: "gluten_free", name: "Gluten-free", upcharge: 1 }
        ]
      },
      sides: {
        title: "American Breakfast - Sides",
        description: "Choose 1",
        limits: {
          "american": 1
        },
        items: [
          ...
          { id: "yogurt", name: "Yogurt", upcharge: 0 },
          { id: "cottage_cheese", name: "Cottage cheese", upcharge: 0 },
          { id: "grits", name: "Grits", upcharge: 0 },
          { id: "oatmeal", name: "Oatmeal", upcharge: 0 }
        ]
      },
      beverages: {
        title: "Breakfast Beverages",
        description: "Choose your beverage options",
        limits: {
          "american": 2,
          "full_monty": 4
        },
        items: [
          { id: "coffee_regular", name: "Coffee - Regular/Decaf", upcharge: 15 },
          { id: "tea", name: "Tea - Hot/Iced", upcharge: 15 },
          { id: "milk", name: "Milk - Whole/2%", upcharge: 0 },
          { id: "juice_orange", name: "Juice - Orange", upcharge: 0 },
          { id: "juice_apple", name: "Juice - Apple", upcharge: 0 },
          { id: "juice_grapefruit", name: "Juice - Grapefruit", upcharge: 0 },
          { id: "juice_cranberry", name: "Juice - Cranberry", upcharge: 0 },
      ...
      sweet_selections: {
        title: "Full Monty Sweet Selections",
        description: "Select sweet breakfast options",
        items: [
          { id: "pancakes", name: "Pancakes", upcharge: 1 },
          { id: "waffles", name: "Waffles", upcharge: 1 },
          { id: "french_toast", name: "French toast with syrup", upcharge: 1 },
          { id: "assorted_pastries", name: "Assorted Pastries", upcharge: 0 },
          { id: "sweet_crepes", name: "Sweet crepes", upcharge: 1 },
          { id: "cinnamon_rolls", name: "Cinnamon rolls", upcharge: 0 },
          { id: "danish", name: "Danish", upcharge: 0 }
        ]
      },
      savory_selections: {
        title: "Full Monty Savory Selections",
        description: "Select savory breakfast options",
        items: [
          { id: "burrito_mexi", name: "Breakfast Burrito - The Mexi", upcharge: 0 },
          { id: "burrito_carnivore", name: "Breakfast Burrito - The Carnivore", upcharge: 0 },
          { id: "burrito_cali", name: "Breakfast Burrito - The Cali", upcharge: 0 },
          { id: "burrito_green", name: "Breakfast Burrito - The Green (Vegetarian)", upcharge: 0 },
          { id: "quiche_green", name: "Quiche - Green (Vegetarian)", upcharge: 0 },
          { id: "mexican_quiche", name: "Mexican Quiche", upcharge: 0 },
          { id: "breakfast_casserole", name: "Breakfast Casserole", upcharge: 1 },
          { id: "denver_hamm", name: "Denver HAMM Breakfast", upcharge: 1 }
        ]
      },
      sides_selections: {
        title: "Full Monty Sides Selections",
        description: "Select side dish options",
        items: [
          { id: "fruits_berries", name: "Fruits and Berries", upcharge: 0 },
          { id: "potatoes", name: "Potatoes", upcharge: 0 },
          { id: "bacon_side", name: "Bacon", upcharge: 0 },
          { id: "sausage_side", name: "Sausage", upcharge: 0 }
        ]
      }
    }
  },
