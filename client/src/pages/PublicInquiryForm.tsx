  ...
  custom_menu: {
    ...
    categories: {
      ...
      american_bbq: {
        ...
        description: "BBQ favorites for your event",
        subcategories: {
          mains: {
            title: "Mains",
            ...
            items: [
              ...
              { id: "bbq_guinness_chicken", name: "BBQ Guiness Chicken", upcharge: 0 },
              ...
              { id: "grilled_cauliflower_steaks", name: "Grilled Cauliflower Steaks", upcharge: 0 }
            ]
          },
          sides: {
            title: "Side Choices",
            ...
            items: [
              ...
              { id: "roasted_brussels_sprouts", name: "Roasted Brussels Sprouts", upcharge: 0 },
          ...
          salads: {
            ...
            items: [
              ...
              { id: "crunchy_asian_slaw", name: "Crunchy Asian Slaw", upcharge: 0 },
              { id: "tossed_cobb", name: "Tossed Cobb", upcharge: 0 },
              { id: "classic_potato", name: "Classic Potato Salad", upcharge: 0 },
      ...
      taste_of_greece: {
        ...
        description: "Greek cuisine options for your event",
        subcategories: {
          mains: {
            title: "Mains",
            description: "Select your desired main dishes",
            items: [
              ...
              { id: "aginares_polita", name: "Aginares -Ala Polita - Vegan", upcharge: 0 },
              { id: "gemista", name: "Gemista - Vegan", upcharge: 0 }
            ]
          },
          sides: {
            title: "Sides",
            ...
            items: [
              ...
              { id: "baked_vegetables_briam", name: "Baked Vegetables- Briam", upcharge: 0 }
            ]
          },
          salads: {
            title: "Salads",
      ...
      kebab_party: {
        ...
        description: "Kebab options for your event",
        subcategories: {
          proteins: {
            title: "Proteins",
            description: "Select your desired protein options",
            items: [
              ...
              { id: "tomato_gnocchi_pesto", name: "Tomato & Gnocchi- with pesto", upcharge: 0 },
      ...
      taste_of_italy: {
        ...
        description: "Italian cuisine options for your event",
        subcategories: {
          mains: {
            title: "Mains",
            description: "Select your desired main dishes",
          ...
          sides: {
            ...
            items: [
              ...
              { id: "baked_cauliflower_parmesan", name: "Baked Cauliflower with bechamel and shaved Parmesan", upcharge: 0 },
          ...
          salads: {
            ...
            items: [
              ...
              { id: "pasta_salad", name: "Pasta Salad", upcharge: 0 },
              { id: "tuscan_orzo_pesto", name: "Tuscan Orzo Pesto Salad", upcharge: 0 }
            ]
          }
        }
      },
      vegan_menu: {
        title: "Vegan Menu - Custom",
        description: "Vegan options for your event",
        subcategories: {
          mains: {
            title: "Main Choices",
            description: "Select your desired main dishes",
            items: [
              { id: "cabbage_rolls", name: "Cabbage rolls- Stuffed with rice dried figs, pine nuts and fresh herbs", upcharge: 0 },
              { id: "eggplant_imam", name: "Eggplant Imam Baildi- Eggplant slices topped with stewed tomato, onions and peppers", upcharge: 0 },
              { id: "indian_stuffed_peppers", name: "Indian style stuffed Peppers - With curried chickpeas, spinach and rice", upcharge: 0 },
              { id: "eggplant_napolean", name: "Eggplant Napolean - with roasted red peppers, Lebanese garlic spread and fresh herbs", upcharge: 0 },
              { id: "artichoke_polita", name: "Artichoke Ala Polita Artichoke hearts, new potatoes, and carrots with lemon tahini sauce", upcharge: 0 },
              { id: "stuffed_portabella", name: "Stuffed Portabella Mushroom- with stewed lentils and cauliflower", upcharge: 0 }
            ]
          },
          sides: {
            title: "Side Choices",
            ...
            items: [
              ...
              { id: "dolmades", name: "Dolmades - Hand-rolled grape leaves, stuffed with bulgur, dried figs and pine nuts. Finished with lemon tahini", upcharge: 0 },
              { id: "cannellini_caponata", name: "Cannellini Beans with caponata", upcharge: 0 },
              { id: "roasted_brussel_sprouts", name: "Roasted Brussel Sprouts - With EVOO and balsamic crema", upcharge: 0 },
              { id: "moroccan_cauliflower", name: "Morrocan-style roasted Cauliflower", upcharge: 0 },
              { id: "brussels_balsamic", name: "Roasted Brussels sprouts with balsamic Crema", upcharge: 0 },
