...
export const weddingThemeMenuData: { [key: string]: WeddingThemeMenu } =
  ...
  taco_fiesta_wedding: {
    title: "Taco Fiesta Wedding",
    description: "Authentic Mexican celebration with fresh ingredients and bold flavors, organized by tiers for different dining experiences.",
    packages: [
      {
        id: "bronze",
        name: "Bronze",
    ...
    categories: {
      mains: {
        title: "Proteins & Main Dishes",
        description: "Select your protein choices and main dishes for an authentic Mexican experience.",
        items: [
          { id: "stuffed_poblano", name: "Stuffed Poblano Peppers with savory rice and beans" },
          { id: "barbacoa", name: "Traditional Barbacoa - slow-cooked beef" },
          { id: "pork_carnitas", name: "Pork Carnitas - tender shredded pork" },
          { id: "pork_belly", name: "Crispy Pork Belly with Mexican spices" },
          { id: "flank_steak_fajitas", name: "Flank Steak Fajitas - marinated and grilled" },
          { id: "ground_beef", name: "Seasoned Ground Beef" },
          { id: "chorizo", name: "Mexican Chorizo - spicy sausage" },
          { id: "mexican_chicken", name: "Mexican-Spiced Chicken" },
          { id: "beef_birria", name: "Beef Birria - traditional stewed beef" },
          { id: "cod", name: "Beer-Battered Cod for fish tacos" },
          { id: "shrimp", name: "Grilled Shrimp with lime and chili" },
          { id: "tofu", name: "Marinated Tofu - plant-based option" },
          { id: "roasted_vegetables", name: "Mexican-Spiced Roasted Vegetables" }
        ]
      },
      sides: {
        title: "Sides & Accompaniments",
        description: "Traditional Mexican sides to complement your meal.",
        items: [
          { id: "cilantro_lime_rice", name: "Cilantro-Lime Rice, fresh and zesty" },
          { id: "mexican_rice", name: "Mexican Rice with tomatoes and spices" },
          { id: "grilled_vegetables", name: "Grilled Vegetables with Mexican seasonings" },
          { id: "refried_beans", name: "Traditional Refried Beans" },
          { id: "jalapeno_cornbread", name: "Jalapeño Cornbread" },
          { id: "elotes", name: "Mexican Street Corn (Elotes)" },
          { id: "rice_and_beans", name: "Classic Rice and Beans" },
          { id: "veg_empanadas", name: "Vegetarian Empanadas" }
        ]
      },
      salads: {
        title: "Fresh Salads",
        description: "Fresh and vibrant salads with Mexican flavors.",
        items: [
          { id: "mexican_slaw", name: "Mexican Coleslaw with lime dressing" },
          { id: "escabeche", name: "Escabeche - pickled vegetables" },
          { id: "pickled_cabbage", name: "Pickled Cabbage slaw" }
        ]
      },
      sauces: {
        title: "Salsas & Sauces",
        description: "Authentic salsas and sauces made fresh daily.",
        items: [
          { id: "pico_de_gallo", name: "Pico de Gallo - fresh tomato salsa" },
          { id: "fresh_mango_salsa", name: "Fresh Mango Salsa with jalapeño" },
          { id: "pineapple_habanero", name: "Pineapple Habanero Salsa - sweet heat" },
          { id: "cucumber_apple", name: "Cucumber Apple Salsa - refreshing" },
          { id: "salsa_roja", name: "Salsa Roja - classic red salsa" },
          { id: "salsa_verde", name: "Salsa Verde - tomatillo salsa" },
          { id: "creamy_salsa_verde", name: "Creamy Salsa Verde" },
          { id: "chorizo_queso_dip", name: "Chorizo Queso Dip" },
          { id: "queso_dip", name: "Classic Queso Dip" },
          { id: "guacamole", name: "Fresh Guacamole" }
        ]
      },
      condiments: {
        title: "Condiments & Toppings",
        description: "Essential toppings and condiments for the perfect taco experience.",
        items: [
          { id: "shredded_cheese", name: "Shredded Mexican Cheese blend" },
          { id: "diced_onions", name: "Diced White Onions" },
          { id: "jalapenos", name: "Fresh Jalapeño slices" },
          { id: "sour_cream", name: "Mexican Crema (Sour Cream)" },
          { id: "vegan_cheese", name: "Vegan Cheese alternative" },
          { id: "lime_wedges", name: "Fresh Lime Wedges" },
          { id: "sliced_radish", name: "Sliced Radish garnish" },
          { id: "diced_bell_peppers", name: "Diced Bell Peppers" },
          { id: "fire_roasted_peppers", name: "Fire-Roasted Peppers" },
