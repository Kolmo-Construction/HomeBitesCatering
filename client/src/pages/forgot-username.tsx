...
export default function ForgotUsername() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Same enumeration-defense reasoning as forgot-password.
    } finally {
      setIsLoading(false);
      setSubmitted(true);
    }
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Forgot your username?</h2>
          ...
          {submitted ? (
            <div className="space-y-4">
              <div className="p-4 bg-green-50 border-l-4 border-green-500 text-green-800 rounded-lg text-sm">
                If an account matches that email, a reminder is on its way.
              </div>
              <Link href="/">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <div className="text-center text-sm">
                ...
                <Link href="/forgot-password">
                  <a className="text-[#8B7355] font-semibold hover:text-[#E28C0A]">Forgot password?</a>
                </Link>
              </div>
            </form>
          )}
